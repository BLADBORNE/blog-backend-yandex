...
@Configuration
@Import({
    IntegrationCommentServiceConfiguration.class,
    IntegrationTagServiceConfiguration.class,
    IntegrationPostRepositoryConfiguration.class
})
public class IntegrationPostServiceConfiguration {
